...
/** GET /api/organizations/{organizationId}/founder/sales — executive Sales view (forecast, at-risk, top opportunities, target progress). No predictive win probability. */
export async function GET(request: Request, { params }: RouteParams) {
  try {
    ...
    const view = await computeExecutiveSalesView(db, { organizationId, workspaceId: parsed.workspaceId ?? null, actorUserId: user.userId });
