...
/** GET /api/organizations/{organizationId}/founder/projects — executive Projects/Delivery view. */
export async function GET(request: Request, { params }: RouteParams) {
  try {
    ...
    const view = await computeExecutiveProjectsView(db, { organizationId, workspaceId: parsed.workspaceId ?? null, actorUserId: user.userId });
