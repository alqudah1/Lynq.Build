...
import { cancelFollowUp } from "@/lib/crm/follow-ups";
...
/** POST /api/organizations/{organizationId}/crm/follow-ups/{followUpId}/cancel */
export async function POST(request: Request, { params }: RouteParams) {
  try {
    ...
    const followUp = await cancelFollowUp(db, { organizationId, followUpId, expectedRevision: body.expectedRevision, actorUserId: user.userId });
