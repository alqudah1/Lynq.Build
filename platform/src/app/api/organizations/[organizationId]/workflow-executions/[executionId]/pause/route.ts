...
import { pauseWorkflowExecution } from "@/lib/workflows/executions";
...
/** POST /api/organizations/{organizationId}/workflow-executions/{executionId}/pause */
export async function POST(request: Request, { params }: RouteParams) {
  try {
    ...
    const execution = await pauseWorkflowExecution(db, { organizationId, executionId, expectedRevision: body.expectedRevision, actorUserId: user.userId });
