...
import { resumeWorkflowExecution } from "@/lib/workflows/executions";
...
/** POST /api/organizations/{organizationId}/workflow-executions/{executionId}/resume */
export async function POST(request: Request, { params }: RouteParams) {
  try {
    ...
    const execution = await resumeWorkflowExecution(db, { organizationId, executionId, expectedRevision: body.expectedRevision, actorUserId: user.userId });
