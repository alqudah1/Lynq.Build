...
import { retryWorkflowExecution } from "@/lib/workflows/executions";
...
/** POST /api/organizations/{organizationId}/workflow-executions/{executionId}/retry */
export async function POST(request: Request, { params }: RouteParams) {
  try {
    ...
    const execution = await retryWorkflowExecution(db, { organizationId, executionId, expectedRevision: body.expectedRevision, actorUserId: user.userId });
