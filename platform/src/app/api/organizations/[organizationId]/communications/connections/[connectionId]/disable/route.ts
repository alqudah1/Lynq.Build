...
import { disableConnection } from "@/lib/communications-os/connections";
...
export async function POST(request: Request, { params }: RouteParams) {
  try {
    ...
    const connection = await disableConnection(db, { organizationId, connectionId, expectedRevision: body.expectedRevision, actorUserId: user.userId });
