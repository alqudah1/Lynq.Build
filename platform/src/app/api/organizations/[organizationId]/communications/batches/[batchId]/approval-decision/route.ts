...
import { applyBulkApprovalDecision } from "@/lib/communications-os/bulk";
...
export async function POST(request: Request, { params }: RouteParams) {
  try {
    ...
    const batch = await applyBulkApprovalDecision(db, { organizationId, batchId, decision: body.decision, decisionNote: body.decisionNote, actorUserId: user.userId });
