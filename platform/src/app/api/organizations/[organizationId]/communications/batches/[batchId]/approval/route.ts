...
import { requestBulkApproval } from "@/lib/communications-os/bulk";
...
export async function POST(request: Request, { params }: RouteParams) {
  try {
    ...
    const batch = await requestBulkApproval(db, { organizationId, batchId, summary: body.summary, actorUserId: user.userId });
